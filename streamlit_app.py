...
import time
from utils import clean_image_advanced, perform_ocr, classify_document
import io
...
if st.session_state.uploaded_file:
    try:
            ...
            st.markdown(f"""
                <section class="card col-12 fade-in delay">
                    ...
                    <div class="image-container">
                        <img src="data:image/jpeg;base64,{st.session_state.uploaded_file.getvalue().hex()}" alt="Uploaded Image" class="responsive-image"/>
                    </div>
                </section>
            """, unsafe_allow_html=True)

        # Start preprocessing and prediction
        st.session_state.status_pre = "Processing..."
        st.session_state.status_pred = "Running inference..."
        ...
        with col_proc:
            ...
            st.markdown(f"""
                <section class="card col-12 fade-in delay">
                    ...
                    <p>Running advanced preprocessing steps...</p>
                    <div class="metrics">
                        <div class="metric">
                            <div class="row"><span class="label">Adaptive Thresholding</span><span class="value">100%</span></div>
                            <div class="bar"><i style="width: 100%;"></i></div>
                        </div>
                        <div class="metric">
                            <div class="row"><span class="label">Noise Reduction</span><span class="value">95%</span></div>
                            <div class="bar"><i style="width: 95%;"></i></div>
                        </div>
                        <div class="metric">
                            <div class="row"><span class="label">Skew Correction</span><span class="value">100%</span></div>
                            <div class="bar"><i style="width: 100%;"></i></div>
                        </div>
                        <div class="metric">
                            <div class="row"><span class="label">Morphological Ops</span><span class="value">100%</span></div>
                            <div class="bar"><i style="width: 100%;"></i></div>
                        </div>
                    </div>
                </section>
        ...
        with st.spinner("Running inference..."):
            ...
            # Use advanced cleaning and OCR
            cleaned_img_array = clean_image_advanced(pil_image)
            text = perform_ocr(cleaned_img_array)
            label, confidence = classify_document(text)
            
            # Update session state with results
            st.session_state.status_pre = "Finished"
        ...
        st.session_state.status_pre = "Error"
        st.session_state.status_pred = "Error"
